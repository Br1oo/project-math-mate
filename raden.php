    ...
    function closeNav() {
      ...
      <body>
        <main> 
          ...
          <p class="text"> Raderen </p>
         
          <section> 
             <div id="raderen"><img id="rad1" src="img/rad.png" alt="" />  </div>   
             <div id="raderen">  <img id="rad2" src="img/rad.png" alt="" /></div>
          </section>  
          
          <section>   
           <button class="Rekenen" onclick="spinIt()">Draaien</button> <br>  
            <button class="Wissen" onclick="wissen()"> Clear </button>  <br>  
          </section> 
          
          <section>  
                <div class="Outputveld" id="resultaat"></div>
           </section> 
